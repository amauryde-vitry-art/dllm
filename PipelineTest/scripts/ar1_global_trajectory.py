...
def main(config_name):
    ...
    ax = axes[0, 0]
    ax.plot(steps, mean_data_c, "o-", color="blue", markersize=3, label="Data (correct)")
    ax.plot(steps, mean_recon_cc, "s--", color="green", markersize=3, label="AR1 correct model")
    ax.plot(steps, mean_recon_ch, "^--", color="red", markersize=3, label="AR1 halluc model")
    ax.set_title("Mean Masked Entropy — Correct samples", fontweight="bold")
    ...
    ax = axes[0, 1]
    ax.plot(steps, mean_data_h, "o-", color="blue", markersize=3, label="Data (halluc)")
    ax.plot(steps, mean_recon_hh, "^--", color="red", markersize=3, label="AR1 halluc model")
    ax.plot(steps, mean_recon_hc, "s--", color="green", markersize=3, label="AR1 correct model")
    ax.set_title("Mean Masked Entropy — Halluc samples", fontweight="bold")
    ax.set_xlabel("Diffusion Step")
    ax.set_ylabel("Mean Entropy")
    ax.legend(fontsize=9)
    ax.grid(True, alpha=0.3)
    ...
    ax = axes[1, 0]
    ax.plot(steps, var_data_c, "o-", color="blue", markersize=3, label="Data (correct)")
    ax.plot(steps, var_recon_cc, "s--", color="green", markersize=3, label="AR1 correct model")
    ax.plot(steps, var_recon_ch, "^--", color="red", markersize=3, label="AR1 halluc model")
    ax.set_title("Var Masked Entropy — Correct samples", fontweight="bold")
    ax.set_xlabel("Diffusion Step")
    ...
    ax = axes[1, 1]
    ax.plot(steps, var_data_h, "o-", color="blue", markersize=3, label="Data (halluc)")
    ax.plot(steps, var_recon_hh, "^--", color="red", markersize=3, label="AR1 halluc model")
    ax.plot(steps, var_recon_hc, "s--", color="green", markersize=3, label="AR1 correct model")
    ax.set_title("Var Masked Entropy — Halluc samples", fontweight="bold")
    ax.set_xlabel("Diffusion Step")
    ax.set_ylabel("Variance")
    ax.legend(fontsize=9)
    ax.grid(True, alpha=0.3)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="llada", choices=["llada", "dream", "llada128_400samples"])
