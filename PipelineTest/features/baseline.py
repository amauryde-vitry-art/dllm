...
def get_baseline_features(outputs, pad_token_id=None):
    ...
    feats = {
        ...
        "AUCMaskedEntropyCurve": auc_masked_entropy_curve(outputs),
        "MaxMaskedEntropyCurve": max_masked_entropy_curve(outputs),
        "ArgmaxMaskedEntropyCurve": argmax_masked_entropy_curve(outputs),
        "SkewnessMaskedEntropyCurve": skewness_masked_entropy_curve(outputs),
        "KurtosisMaskedEntropyCurve": kurtosis_masked_entropy_curve(outputs),
